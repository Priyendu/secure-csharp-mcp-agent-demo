...
Secure MCP (Model Context Protocol) server and client demo using .NET 8, JWT authentication, scope-based authorization, audit logging, demo release data, and a simple rule-based agent planner.
